...
const HeroSection = () => {
  const styles = {
    heroContainer: {
      ...
      background: 'radial-gradient(circle at top right, #e8f5e9 0%, #ffffff 40%, #ffffff 100%)',
      padding: '60px 8%',
      minHeight: '80vh',
      display: 'flex',
      ...
      <div style={styles.layout}>
        ...
        <div>
          ...
          <div style={styles.btnRow}>
            <button style={styles.exploreBtn}>
              Explore Services <span style={{fontSize: '20px'}}>→</span>
            </button>
        ...
        <div style={styles.imageWrapper}>
          <img 
            ...
            alt="Business team shaking hands" 
          ...
          <div style={styles.floatingCard}>
            ...
            <div>
              <div style={{ fontWeight: '800', color: '#111827', fontSize: '16px' }}>Growing every month</div>
              <div style={{ fontSize: '14px', color: '#6b7280' }}>Sustainable & scalable</div>
            </div>
          </div>
        </div>
      </div>
